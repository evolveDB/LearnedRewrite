...
public class test_with_lex {
    public static void main(String[] args) throws Exception {
        ...
        RelToSqlConverter converter = new RelToSqlConverter(MysqlSqlDialect.DEFAULT);
        String new_sql = converter.visitRoot(rel_node).asStatement().toSqlString(MysqlSqlDialect.DEFAULT).getSql();
        ...
        String cleaned_sql = converter.visitRoot(rel_node).asStatement().toSqlString(MysqlSqlDialect.DEFAULT).getSql();
