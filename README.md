...
![demo](src/main/resources/demo_code.gif)

*Use Api*

项目中带了HttpServer,可直接运行```nohup /root/jdk-15/bin/java -jar {{输入项目路径}}/rewriter_java.jar --main.java.org.db.autonomous.server.port=6336 &```，端口为**6336**
* api: /rewriter POST {sql: "select....", schema: {....}}

![demo](src/main/resources/demo_api.gif)
